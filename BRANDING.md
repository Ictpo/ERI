...
```tsx
// eri-icon.png goes in frontend/public/
...
## Step 5 — Optional Snowfall loader
  ...
  return (
    <div className="relative flex flex-col items-center gap-6 overflow-hidden rounded-xl bg-[#0C0709] px-8 py-14">
      ...
      <div className="relative flex h-[120px] w-[120px] items-center justify-center">
        ...
        <img src="/eri-icon.png" alt="" className="relative h-[120px] w-[120px] rounded-full" />
      </div>
        ...
        <div className="grid grid-cols-[0.75fr_1.25fr]">
          ...
          <div className="p-7">
            <div className="mb-3 flex items-center gap-2">
              <img src="/eri-icon.png" className="h-7 w-7 rounded-full" />
...
the workspace header. Put the fox art at `frontend/public/eri-fox.jpg`. The
...
- `eri-icon.png` — the round fox mark (use the 256 source, or 32/48 where small).
- `eri-fox.jpg` — the character art for the About window.
